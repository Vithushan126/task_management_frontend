...
import { logout } from '@/redux/feature/auth/auth-thunk';
...
export default function UserDropdown() {
  ...
  useEffect(() => {
    ...
    if (savedState === 'true' && screenfull.isEnabled) {
  ...
  // Toggle fullscreen and persist state
  const toggleFullscreen = () => {
    if (screenfull.isEnabled) {
      screenfull.toggle().then(() => {
        const newState = screenfull.isFullscreen;
